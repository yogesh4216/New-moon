...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      initialize: (...args_1) => {
        ...
        const initial_count_0 = args_1[1];
        ...
        if (!(typeof(initial_count_0) === 'bigint' && initial_count_0 >= 0n && initial_count_0 <= 4294967295n)) {
          __compactRuntime.typeError('initialize',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(initial_count_0),
      ...
      increment: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const increment_amount_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        if (!(typeof(increment_amount_0) === 'bigint' && increment_amount_0 >= 0n && increment_amount_0 <= 4294967295n)) {
          __compactRuntime.typeError('increment',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'counter.compact line 22 char 1',
                                     'Uint<0..4294967296>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(increment_amount_0),
            alignment: _descriptor_0.alignment()
          },
          output: undefined,
          publicTranscript: [],
  ...
  _initialize_0(context, partialProofData, initial_count_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(initial_count_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
  _increment_0(context, partialProofData, increment_amount_0) {
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 25 char 13: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
